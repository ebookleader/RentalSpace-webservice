...
public class ProductsSaveRequestDto {
    ...
    public Products toEntity() {
        return Products.builder()
                ...
                .p_facility2(p_facility2)
                .p_facility3(p_facility3)
                .p_facility4(p_facility4)
                .p_facility5(p_facility5)
                .p_facility6(p_facility6)
                .p_facility7(p_facility7)
                .p_facility8(p_facility8)
                .p_facility9(p_facility9)
                .p_facility10(p_facility10)
                .p_notice(p_notice)
                .p_policy(p_policy)
                .p_maxNum(p_maxNum)
                .p_liked(p_liked)
